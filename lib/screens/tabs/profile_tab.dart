...
class _ProfileTabState extends State<ProfileTab> {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if (authProvider.isAuthenticated)
              _buildAuthenticatedContent(context, isDark, authProvider)
            else
  ...
  Widget _buildAuthenticatedContent(BuildContext context, bool isDark, AuthProvider authProvider) {
    return Column(
      children: [
        _buildSectionHeader(
        ...
        _buildEmptyStateCard(
          ...
          description: 'Start by asking your first legal question in the Home tab',
        ),
        _buildSectionHeader(
        ...
        _buildEmptyStateCard(
          ...
          description: 'Save important legal advice for quick reference',
        ),
      ],
    );
  }
  ...
  // UPDATED: Delete account dialog with password verification
